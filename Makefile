...
# all
all: main.o LinkedList.o Hashtable.o Hamming.o CosineSim.o Euclidean.o DistanceMatrix.o randomfunc.o NeighbourSearch.o ../CppApplication_12/Distances.o ../CppApplication_12/Cluster.o
	g++ -g main.o LinkedList.o Hashtable.o Hamming.o CosineSim.o Euclidean.o DistanceMatrix.o randomfunc.o NeighbourSearch.o ../CppApplication_12/Distances.o ../CppApplication_12/Cluster.o -o lsh -lm
...
Distances.o: ../CppApplication_12/Distances.cpp ../CppApplication_12/Distances.h
	g++ -std=c++0x -c -g ../CppApplication_12/Distances.cpp
	
Cluster.o: ../CppApplication_12/Cluster.cpp ../CppApplication_12/Cluster.h
	g++ -std=c++0x -c -g ../CppApplication_12/Cluster.cpp
